  ...
  return (
    <>
      <ScenarioCard
        ...
        note={
          <p>
            ...
            <strong>строит графики и формирует краткий аналитический документ</strong><br></br>
      ...
      <ScenarioCard
        ...
        text={
          <>
            Система находит формулы и числовые значения, подставляет данные <br></br> и показывает
