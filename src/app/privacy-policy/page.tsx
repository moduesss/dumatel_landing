...
export const metadata: Metadata = {
  ...
  description:
    "Политика обработки персональных данных ООО «Валамис» для сайта dumatel.ru.",
};
        ...
        <div className={styles.container}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              ...
              ООО «Валамис» (далее — Оператор).
            </p>
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>1.1.</span> Оператор ставит
              своей важнейшей целью и условием осуществления своей деятельности
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>1.2.</span> Настоящая политика
              Оператора в отношении обработки персональных данных (далее —
              Политика) применяется ко всей информации, которую Оператор может
              получить о посетителях веб-сайта https://dumatel.ru.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.list}>
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.2.</span> Блокирование
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.3.</span> Веб-сайт —
                ...
                сети интернет по сетевому адресу https://dumatel.ru.
              </p>
              <p className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.5.</span> Обезличивание
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.6.</span> Обработка
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.7.</span> Оператор —
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.8.</span> Персональные
                данные — любая информация, относящаяся прямо или косвенно к
                определенному или определяемому Пользователю веб-сайта
                https://dumatel.ru.
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.9.</span> Персональные
                данные, разрешенные субъектом персональных данных для
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.10.</span> Пользователь —
                любой посетитель веб-сайта https://dumatel.ru.
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.11.</span> Предоставление
                персональных данных — действия, направленные на раскрытие
                персональных данных определенному лицу или определенному кругу
                лиц.
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.12.</span> Распространение
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.13.</span>
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>2.14.</span> Уничтожение
                персональных данных — любые действия, в результате которых
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>3.1.</span> Оператор имеет
              право:
            </p>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>3.2.</span> Оператор обязан:
            </p>
            <ul className={styles.bullets}>
              <li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>4.1.</span> Субъекты
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>4.2.</span> Субъекты
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>4.3.</span> Лица, передавшие
          ...
          <section className={styles.section}>
            ...
            <div className={styles.list}>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>5.1.</span> Обработка
                персональных данных осуществляется на законной и справедливой
                основе.
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>5.2.</span> Обработка
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>5.7.</span> Хранение
                персональных данных осуществляется в форме, позволяющей
          ...
          <section className={styles.section}>
            ...
            <div className={styles.list}>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.1.</span> Обработка
                персональных данных осуществляется с согласия субъекта
                персональных данных на обработку его персональных данных.
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.2.</span> Обработка
                персональных данных необходима для достижения целей,
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.3.</span> Обработка
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.4.</span> Обработка
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.5.</span> Обработка
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.6.</span> Осуществляется
                обработка персональных данных, доступ неограниченного круга лиц
                к которым предоставлен субъектом персональных данных либо по его
                просьбе (далее — общедоступные персональные данные).
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>7.7.</span> Осуществляется
          ...
          <section className={styles.section}>
            ...
            <div className={styles.list}>
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>8.3.</span> В случае
                ...
                уведомление на адрес электронной почты Оператора info@dumatel.ru
                с пометкой «Актуализация персональных данных».
              </p>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>8.4.</span> Срок обработки
                персональных данных определяется достижением целей, для которых
                были собраны персональные данные, если иной срок не предусмотрен
            ...
            <p className={styles.paragraph}>
              ...
              info@dumatel.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <div className={styles.list}>
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>8.5.</span> Вся информация,
                которая собирается сторонними сервисами, в том числе платежными
                системами, средствами связи и другими поставщиками услуг,
              ...
              <p className={styles.paragraph}>
                <span className={styles.itemNumber}>8.9.</span> Условием
                прекращения обработки персональных данных может являться
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>9.1.</span> Оператор
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>10.1.</span> Оператор до начала
              осуществления деятельности по трансграничной передаче персональных
              данных обязан уведомить уполномоченный орган по защите прав
              ...
              направляется отдельно от уведомления о намерении осуществлять
              обработку персональных данных).
            </p>
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>10.2.</span> Оператор до подачи
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>12.1.</span> Пользователь может
              ...
              помощью электронной почты info@dumatel.ru.
            </p>
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>12.2.</span> В данном документе
              будут отражены любые изменения политики обработки персональных
              данных Оператора. Политика действует бессрочно до замены ее новой
              версией.
            </p>
            <p className={styles.paragraph}>
              <span className={styles.itemNumber}>12.3.</span> Актуальная версия
              Политики в свободном доступе расположена в сети Интернет по
              адресу https://dumatel.ru.
            </p>
          </section>
        </div>
      </main>
